...
public class WeatherConfigurator {
    private String[] weatherCodes = {"MI","PR","BC","DR","BL","SH","VC","TS","FZ","DZ","RA","SN","SG","IC","PL","GR","GS","UP","RR","FG","FU","VA","DU","SA","HZ","PY","PO","SQ","FC","SS","DS","CB","LTG"};
        ...
        while(true) {
            ...
            for (String weatherCode : weatherCodes) {
                if (weatherData[index].contains(weatherCode)) {
                    if(weatherCode == "TS" || weatherCode == "FZ" || weatherCode == "GR" || weatherCode == "LTG" || weatherCode == "SQ") {
                        aw.setConvective(true);
                    }
                    isWeatherCode = true;
                }
            }
