...
import WeatherConfigurator.Wind;
...
public class AirportWeather {
    ...
    private boolean isConvective = false;
    ...
    public boolean isBadWeather() {
        ...
        if(getWind().getM_speed() < 20) {
            if(getWind().isM_isGusting() && getWind().getM_gustSpeed() > 25) return true;
        } else {
            return true;
        }
